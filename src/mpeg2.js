JSMpeg.Decoder.MPEG2Video = (function () {
    "use strict";
...
// https://sourceforge.net/projects/javampeg1video/
    ...
    MPEG2.prototype.decode = function () {
        ...
        const elapsedTime = JSMpeg.Now() - startTime;
     ...
     * @type {number}
     */
    MPEG2.prototype.forwardFCode = 0;
     ...
     * @type {number}
     */
    MPEG2.prototype.forwardF = 0;

    /**
     * Раскодировать фрейм
     * @param skipOutput нужен для пропуска чего?
     */
    MPEG2.prototype.decodePicture = function (skipOutput) {
    ...
    MPEG2.prototype.decodeMotionVectors = function () {
        var code, d, r = 0;
...
// VLC Tables and Constants
     ...
     * @type {Uint8Array}
     */
    MPEG2.ZIG_ZAG_DEFAULT = new Uint8Array([
        0, 1, 5, 6, 14, 15, 27, 28,
     ...
     * @type {Uint8Array}
     */
    MPEG2.ZIG_ZAG_ALTERNATE = new Uint8Array([
